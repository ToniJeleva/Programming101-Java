...
public class LinkedList<T extends Comparable<T>> {
	...
	void splice(LinkedList<T> other, Node<T> start, Node<T> end) {
		LinkedList<T> copied = other.copy();
	...
	public LinkedList<T> splitAt(Node<T> node) {
	...
	public LinkedList<T> removeDuplicates1() {
		LinkedList<T> newList = this.copy();
	...
	// Using HashSet
	public LinkedList<T> removeDuplicates2() {
	...
	public LinkedList<T> sortedMerge(LinkedList<T> other) {
		LinkedList<T> newList = new LinkedList<T>();
